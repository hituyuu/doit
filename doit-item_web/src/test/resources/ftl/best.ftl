...
#banner .bd .bn1{ background:url(images/1.jpg) no-repeat center 0;}
#banner .bd .bn2{ background:url(images/sssss0423.jpg) no-repeat center 0;}
#banner .bd .bn3{ background:url(images/1111.jpg) no-repeat center 0;}
#banner .bd .bn4{ background:url(images/bg.jpg) no-repeat center 0;}
#banner .bd .bn5{ background:url(images/best20180103.jpg) no-repeat center 0;}
#banner .bd .bn6{ background:url(images/best20170310.jpg) no-repeat center 0;}
#banner .bd .bn7{ background:url(images/best360zn.jpg) no-repeat center 0;}
#banner .bd .bn88{ background:url(images/ucargo.jpg) no-repeat center 0;}
#banner .bd .bn9{ background:url(images/best0212.jpg) no-repeat center 0;}
#banner .bd .bn90{ background:url(images/0810.jpg) no-repeat center 0;}
</style>
	...
	<div class="header">
		...
		<div class="logo">
			<div class="w980 clearfix">
				<div class="left">
					<a href="/"><img src="picture/logo_index.png" alt="百世" /></a>
				</div>
				<div class="right">
	...
	<div class="main index-main">
    	<div class="w980 mbox">
    		...
    		<div class="item news clearfix">
    			...
    			<div class="news-list">
    				<ul>
						<li class='clearfix'><div class='pic'><a href='/news/493.shtml'><img src='picture/060107.png' onerror='this.src="/img/news_no.jpg"' /></a></div><div class='txt'><h2><a href='/news/493.shtml' title='中国物流与采购网：“新玩家”的运筹帷幄！百世国际以智慧供应链服务跨境电商'>中国物流与采购网：“新玩家”的运筹帷幄！</a></h2><p>百世国际针对美国市场推出了海运FBA拼箱及整柜直送服务以及空运FBA专线，并提供...</p></div></li>
<li class='clearfix'><div class='pic'><a href='/news/492.shtml'><img src='picture/060103.jpg' onerror='this.src="/img/news_no.jpg"' /></a></div><div class='txt'><h2><a href='/news/492.shtml' title='中国网：以供应链赋能新零售 百世店加有新解'>中国网：以供应链赋能新零售 百世店加有新</a></h2><p>中国报道讯 （杨金鑫报道）在最新发布的《2018中国便利店发展报告》（以下简称“...</p></div></li>
...
<div class="footer">
	...
	<div class="w980 clearfix mt14">
		...
		<div class="contact clearfix">
			<div class="left" style="display:none;"><img src="picture/wx.jpg" alt="" /></div>
	...
	<div class="w980 clearfix mt44">
		<div class="auth">
			<a  style="display:none;" href="http://122.224.75.236/wzba/login.do?method=hdurl&doamin=http://www.800best.com&id=330108000004538&SHID=1223.0AFF_NAME=com.rouger.gs.main.UserInfoAff&AFF_ACTION=qyhzdetail&PAGE_URL=ShowDetail" target="_blank"><img src="picture/gh.jpg" alt="" /></a>&nbsp;&nbsp;
			<a href="http://www.moc.gov.cn/" target="_blank"><img src="picture/fc2.jpg" alt="" /></a>&nbsp;&nbsp;
			<a   style="display:none;" href="http://www.chinawuliu.com.cn/" target="_blank"><img src="picture/fc3.jpg" alt="" /></a>
...
<div class="sidebar">
	<img src="picture/gotop.png" alt="回到顶部" class="backtop"/>
</div>
<div id="counter" style="display:none;"><script src="js/stat.js" language="JavaScript"></script></div>
<script src="js/superslide.js"></script>
<script src="js/com.js"></script>
<script src="js/jquery-ui-1.9.2.custom.min.js"></script>
<script src="js/jquery.tagthis.js"></script>
